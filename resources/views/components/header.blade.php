    ...
    <div class="w-full bg-white container mx-auto px-6 py-4">
        ...
        <div class="w-full mt-6 pb-4 flex items-center justify-between gap-6 border-b border-black">
            <div class="w-fit flex items-center gap-4">
                <a type="button" class="hidden md:block text-white bg-black hover:bg-white hover:text-black focus:bg-black focus:text-white border border-black font-medium text-sm px-5 py-1 focus:outline-none cursor-pointer">إنشاء </a>
                <a type="button" class="hidden md:block text-black bg-white hover:bg-black hover:text-white focus:bg-white focus:text-black border border-black font-medium text-sm px-5 py-1 focus:outline-none cursor-pointer">تسجيل</a>
