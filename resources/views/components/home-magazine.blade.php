<section class="w-full mt-6 bg-primary-50">
    <div class="w-full p-6 lg:px-0 lg:py-[5%] container mx-auto">
        ...
        <div class="w-full mt-8 text-right flex flex-col lg:flex-row items-center justify-center gap-6" dir="rtl">
            <div class="w-full max-w-md">
                <a href="#">
                    <img src="{{env('IMAGEKIT_ENDPOINT') . '/' . $magazine->cover_image}}" alt="Annahda Magazine Cover Image" class="w-full">
                </a>
            </div>
            <div class="w-full lg:px-6 py-8">
                ...
                <div class="w-full mt-8 grid lg:grid-cols-3 gap-6">
                    ...
                    <a href="{{route('view-article', ['category' => $article->category->slug, 'slug'=> $article->slug])}}" class="relative w-full h-[210px]">
