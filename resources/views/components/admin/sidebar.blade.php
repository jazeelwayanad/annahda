                ...
                <div class="w-full mb-8 space-y-8 divide divide-gray-200">
                    ...
                    <div class="w-full">
                        ...
                        <ul class="w-full mt-2 space-y-2 font-medium">
                            ...
                            @endcan
                            <li>
                                <a href="{{ route('admin.subscriptions') }}" class="w-full flex items-center px-3 py-2 text-gray-900 group rounded-lg {{ Route::current()->getName() == 'admin.subscriptions' ? 'bg-zinc-100' : 'hover:bg-gray-100' }}">
                                    <svg class="w-5 h-5 transition duration-75 {{ Route::current()->getName() == 'admin.subscriptions' ? 'fill-primary-600' : 'fill-gray-500 group-hover:fill-gray-900' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2C6.579 2 2 6.579 2 12s4.579 10 10 10 10-4.579 10-10S17.421 2 12 2zm0 5c1.727 0 3 1.272 3 3s-1.273 3-3 3c-1.726 0-3-1.272-3-3s1.274-3 3-3zm-5.106 9.772c.897-1.32 2.393-2.2 4.106-2.2h2c1.714 0 3.209.88 4.106 2.2C15.828 18.14 14.015 19 12 19s-3.828-.86-5.106-2.228z"></path></svg>
                                    <span class="ms-4 text-base {{ Route::current()->getName() == 'admin.subscriptions' ? 'text-primary-600 font-bold' : '' }}">Subscriptions</span>
                                </a>
                            </li>
                            <li>
